...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    static class Runningturtle extends Thread {
        private final int turtleNumber;
        private Turtle turtle;
        public Runningturtle(int turtleNumber, Turtle turtle) {
            this.turtleNumber = turtleNumber;
            this.turtle = turtle;
        }
        @Override
        public void run() {
            System.out.println("Turtle " + turtleNumber + " is moving...");

            // Set the initial position of each turtle based on its number
            if (turtleNumber == 1) {
                turtle.penColor("blue");
                turtle.width(5);
                turtle.speed(50);
                turtle.up(); // Lift the pen to move without drawing
                turtle.setPosition(220, 150); // Set initial position to the left
                turtle.down(); // Start drawing
            } else if (turtleNumber == 2) {
                turtle.penColor("green");
                turtle.width(5);
                turtle.speed(50);
                turtle.up();
                turtle.setPosition(0, 0); // Set initial position to the center
                turtle.down();
                ...
                turtle.speed(50);
                turtle.up();
                turtle.setPosition(200, -150); // Set initial position to the right
                turtle.down();
            }
    ...
    public static void main(String[] a)
    {
        ...
        Thread tt1 = new Runningturtle(1, turtle1);
        Thread tt2 = new Runningturtle(2, turtle2);
        Thread tt3 = new Runningturtle(3, turtle3);
        tt1.start();
        tt2.start();
        tt3.start();
    }
